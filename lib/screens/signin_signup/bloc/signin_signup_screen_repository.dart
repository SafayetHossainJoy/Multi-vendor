...
abstract class SigninSignupScreenRepository {
  Future<SignUpScreenModel>? signUp(String email, String password, String name, SignUpDetails sellerDetails );
...
class SigninSignupScreenRepositoryImp implements SigninSignupScreenRepository {
  ...
  Future<SignUpScreenModel>? signUp(
      String email, String password, String name,SignUpDetails sellerDetails ) async {
