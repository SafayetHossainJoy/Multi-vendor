...
import 'package:flutter_project_structure/screens/signin_signup/view/social_login.dart';
        ...
        child: SafeArea(
          ...
          children: <Widget>[
            Expanded(
              child: Center(
                child: Column(
                  ...
                  children: [
                    CircleAvatar(
                      backgroundImage: AssetImage('lib/assets/images/appIcon.png'),
                      radius:50,
                    ),
                    Padding(
                      ...
                      child: Center(
                        child: Text(
                          _localizations?.translate(MarketplaceStringConstant.appName) ??
                              "",
            ...
            model?.allowSignup ?? true
                ...
                : Container(),
            SizedBox(height: AppSizes.extraPadding),
            if ((model?.allowFacebookSign ?? true) ||
