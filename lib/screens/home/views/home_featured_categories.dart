          ...
          GestureDetector(
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  // border:
                  //     Border.all(color: MobikulTheme.accentColor, width: 0.0),
                image:DecorationImage(image: NetworkImage(category.url ?? "",),fit: BoxFit.fill, )
              ),
              // child: CircleAvatar(
              //   backgroundColor: Theme.of(context).cardColor,
              //   child: Padding(
              //     padding: const EdgeInsets.all(AppSizes.mediumPadding /2),
              //     child: Image.network(
              //       category.url ?? "",
              //       fit: BoxFit.fill,
              //     ),
