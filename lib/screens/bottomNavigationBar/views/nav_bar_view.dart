    ...
    return Scaffold(
      bottomNavigationBar: BlocBuilder<NavigationCubit, NavigationState>(
        ...
        return BottomNavigationBar(
          ...
          // unselectedIconTheme: const IconThemeData(shadows: [Shadow(color: AppColors.darkGray , blurRadius:0, offset: Offset(0.2,1.5))]),
          // selectedIconTheme: IconThemeData(shadows: [Shadow(color: Theme.of(context).bottomAppBarTheme.color! , blurRadius:0.2, offset: Offset(0.2,1.5))]),
          // selectedLabelStyle: TextStyle(shadows: [Shadow(color: Theme.of(context).bottomAppBarTheme.color! , blurRadius:0.2, offset: Offset(0.2,0.5))]),
          // unselectedLabelStyle: const TextStyle(shadows: [Shadow(color: AppColors.darkGray , blurRadius:0.2, offset: Offset(0.2,0.5))]),
          items: [
