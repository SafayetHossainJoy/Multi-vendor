          ...
          title: SizedBox(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                contentPadding: const EdgeInsets.only(top: 0,left: AppSizes.sidePadding),
            ...
            SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Visibility(
                      visible: (!isLoading) && (searchModel?.products?.isNotEmpty ?? false),
                      child: suggestionList(searchModel, context, _localizations)
                    // : Padding(
