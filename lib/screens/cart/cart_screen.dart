            ...
            TextButton(
                ...
                child: Text(
                  (_localizations
                          ...
                          "")
                      .toUpperCase(),
                  style: Theme.of(context).textTheme.bodyText1?.copyWith(color: Theme.of(context).appBarTheme.iconTheme?.color),
                ))
          ]),
      body: SafeArea(
      ...
      children: <Widget>[
        Visibility(
          ...
          child: cartViewModel?.cartCount == 0 ||
              ...
              ? lottieAnimation(
                  context,
              (Theme.of(context).brightness == Brightness.light) ? "lib/assets/lottie/empty_cart.json" : "lib/assets/lottie/empty_cart_dark.json",
