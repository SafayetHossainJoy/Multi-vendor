      ...
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            // Image
            // ImageView(
            //   url: "https://demo.webkul.com/web/image/product.product/26/image_1920?unique=20210316172608",
            //   height: 96,
            //   width: 96,
            // ),
        ...
        actionContainer(
          context,
          () {
            Navigator.pushNamed(context, orderDetails, arguments: getOrderDetailDataMap(item?.url ?? ''));
          },
          () {
            callback(item?.url ?? '');
          },
