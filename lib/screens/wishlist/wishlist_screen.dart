  ...
  Widget buildUI(List<WishListItems>? items, BuildContext context) {
    return isLoading
        ...
        child: (wishlistModel?.wishLists ?? []).isEmpty ||
            ...
            ? lottieAnimation(
            context,
            (Theme.of(context).brightness == Brightness.light) ? "lib/assets/lottie/empty_wishlist.json" :"lib/assets/lottie/empty_wishlist_dark.json",
    ...
    return Stack(children: [
      GridView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            var imageSize = (AppSizes.width / 2.7) - AppSizes.linePadding;
            return Stack(children: [
              // Container(
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical:AppSizes.imageRadius, horizontal: AppSizes.linePadding),
                              child: ImageView(
