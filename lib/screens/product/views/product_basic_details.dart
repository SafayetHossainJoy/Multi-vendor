        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: <Widget>[
                Text(((widget.product?.priceReduce ?? '') != '')
                  ...
                  onTap: () {
                    if (AppSharedPref().getIfLogin() != null &&
                      ...
                      reviewBottomModalSheet(
                        ...
                        widget.productPageBloc?.add(ProductScreenDataFetchEvent(
                    ...
                    if (AppSharedPref().getIfLogin() != null &&
                      ...
                      !widget.addedToWishlist
                          ...
                          : widget.productPageBloc?.add(RemoveFromWishlistEvent(
                              widget.product?.productId.toString()));
                      widget.productPageBloc?.emit(ProductScreenInitial());
                      AnalyticsEventsFirebase().addWishListEvent(widget.product?.productId.toString() ?? "", widget.product?.name ?? "", widget.product?.productCount ?? 1);
