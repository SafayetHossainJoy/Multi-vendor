              ...
              child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                            ...
                            children: [
                              Stack(
                                children: [
                                  ...
                                  if (getArStatus())
                                    InkWell(
                                      child: Icon(Icons.border_clear_rounded, color: AppColors.lightGray,),
                      ...
                      AddToCartButtonView(productPageBloc,
                          productPageData?.productId ?? 0,productPageData?.name ?? '', counter!),
                      ProductDetailsView(productPageData?.description),
                      // ProductMoreInformation(),
                      if ((AppSharedPref().getSplashData()?.addons?.review ?? false) && (productPageData?.totalReview ?? 0) > 0) reviewTile(),
