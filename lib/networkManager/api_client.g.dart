...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<HomePageData> getHomePageData(apiKey) async {
  ...
  Future<ProductScreenModel> getProductData(
    ...
    final _data = {'apiKey': apiKey};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ProductScreenModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/x-www-form-urlencoded',
  ...
  Future<SignUpScreenModel> getCustomerSignUp(data) async {
    ...
    final _data = data;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<SignUpScreenModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ReviewListModel> getReviewList(data) async {
    ...
    final _data = data;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ReviewListModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<CartViewModel> getCartData() async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<CartViewModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AddressDetailModel> getAddressDetails(endpoint) async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<AddressDetailModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<OrderReviewModel> getOrderReviewData(data) async {
    ...
    final _data = data;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<OrderReviewModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<PlaceOrderModel> placeOrder(data) async {
    ...
    final _data = data;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PlaceOrderModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<NotificationList> markReadNotification(
    ...
    final _data = data;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<NotificationList>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<SearchScreenModel> getSearchList(data) async {
    ...
    final _data = data;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<SearchScreenModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
