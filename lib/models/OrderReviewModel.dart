...
class PaymentData {
  ...
  @JsonKey(name: 'pi_token')
  final String? piToken;
  @JsonKey(name: "customer_email")
  String? customerEmail;
  @JsonKey(name: "call_back_url")
  String? callBackUrl;
  @JsonKey(name: "stripe_customer_id")
  String? stripeCustomerId;

  PaymentData({this.status, this.code, this.auth, this.customerEmail,this.secretKey,this.publishableKey,this.piToken, this.callBackUrl, this.stripeCustomerId});
