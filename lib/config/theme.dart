...
class MobikulTheme {
  ...
  static const Color clientPrimaryColor = Color(0xFF3BB44A);  // replace with client primary color
  static const Color clientAccentColor = Color(0xFFFB5607);     // replace with client accent color
